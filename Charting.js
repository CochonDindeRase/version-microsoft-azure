...
// Rendu des images
renderSectionImages(".dents1", "./dents/maxillairevestibulaire.json", "maxV");
renderSectionImages(".dents2", "./dents/mandibulevestibulaire.json", "mandV");
renderSectionImages(".dents3", "./dents/maxillairepalatin.json", "maxP");
renderSectionImages(".dents4", "./dents/mandibulepalatin.json", "mandP");
